...
int main (){
	...
	/* Memastikan bahwa input diameter pipa tidak negatif atau 0 */
	 
	else if (d <= 0){
		cout<<"\nError. Diameter pipa tidak dapat bernilai negatif atau 0!";
		return 0;
	}
	...
	switch (T) {
		...
		case 15:
			...
			break;
		default:
			cout<<"\nError. Input suhu air salah! (5\370C, 10\370C atau 15\370C)";
			return 0;
	}
	...
	*/
	...
	/* Tipe aliran berdasarkan Bilangan Reynold */
